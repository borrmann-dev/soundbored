defmodule SoundboardWeb.Components.Soundboard.UploadModal do
  ...
  def upload_modal(assigns) do
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div class="relative transform overflow-hidden rounded-lg bg-white dark:bg-gray-800 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
            ...
            <div class="mt-3 sm:mt-5">
              <h3 class="text-base font-semibold leading-6 text-gray-900 dark:text-gray-100 mb-4 text-center">
                Add Sound
              </h3>
    ...
    <!-- Right Column: Tags, Keywords & Settings -->
                  <div class="space-y-4">
                    <!-- Tags -->
                    <div class="text-left">
                      ...
                      <TagComponents.tag_badge_list
                        tags={@upload_tags}
                        remove_event="remove_upload_tag"
                      />
                    </div>
    ...
    <!-- Keywords -->
                    <div class="text-left">
                      <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        Keywords <span class="text-gray-400 font-normal text-xs">(search terms)</span>
                      </label>
                      <input
                        type="text"
                        name="keywords"
                        value={@upload_keywords}
